...
local cables = {
  arrIn = Bundle:new(CABLE_SIDE,colors.lime),
  arrOut = Bundle:new(CABLE_SIDE,colors.pink)
}
...
function Security.start()
  ...
  local arrival = gen_server.start_link(Security,{"monitor_201","ARRIVALS CONTROL",arrIn,arrOut},{})
